	...
	<script>
		...
		$(document).ready(function() {
			  chart1 = new Highcharts.Chart({
				 ...
				 title: {
					text: 'Count of Complaint Portal'
				 },
				 xAxis: {
		...
		$(document).ready(function() {
			  chart1 = new Highcharts.Chart({
				 ...
				 title: {
					text: 'Top 10 Store Location Complaint '
				 },
				 xAxis: {
					categories: ['Store']
				 },
  ...
  <div class="row">
	...
	<div style="margin-top:20px">
	  ...
	  <div class="col-sm-12">
  	  ...
  	  <!-- <div class="col-sm-6">
          <div class="panel panel-primary">
			<div class="panel-heading">Complaint of Complaint Type 
			</div>
			<div class="panel-body">
					 <div id ="mygraph3"></div>
			</div>
