<?php
    ...
    $mail->MsgHTML("Hi, Data customer complaint baru atas nama ".$name." telah diinput oleh admin, mohon tanggapi data tersebut ya.. cek pada link berikut https://complaint.hometowndairy.co.id. Thank you.. :) ");
